...
/**
 * An {@code Addition} represents an addition operation.
 * 
 * @author Jeong-Hyon Hwang (jhh@cs.albany.edu)
 */
class Addition extends BinaryNumericOperation {

	/**
	 * Constructs an {@code Addition}.
	 * 
	 * @param left
	 *            the left child
	 * @param right
	...
	/**
	 * Evaluates the expression represented by this {@code Addition} and its descendants.
	 * 
	 * @return the result of evaluating the expression represented by this {@code Addition} and its descendants
	 */
	@Override
